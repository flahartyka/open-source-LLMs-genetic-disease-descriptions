...
python3 gen_model_answer.py --model-path lmsys/vicuna-13b-v1.3 --model-id vicuna-13b-v1.3 --answer-file "data/mt_bench/model_answer/vicuna-13/q1_result.jsonl" --question-file "data/mt_bench/vicuna_q1.jsonl" 
...
# answers are located in 'llm_project/FastChat/fastchat/llm_judge/data/mt_bench/model_answer/vicuna-13'
